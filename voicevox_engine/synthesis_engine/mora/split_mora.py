...
from ...acoustic_feature_extractor import BasePhoneme

unvoiced_mora_phoneme_list = ["A", "I", "U", "E", "O", "cl", "pau"]
mora_phoneme_list = ["a", "i", "u", "e", "o", "N"] + unvoiced_mora_phoneme_list

P = TypeVar("P", bound=BasePhoneme)


def split_mora(phoneme_list: List[P]):
    """
    BasePhonemeを継承するPのリストから、
    母音の位置(vowel_indexes)
    ...
    Returns
    -------
    consonant_phoneme_list : List[P]
        子音の音素列
    vowel_phoneme_list : List[P]
        母音の音素列
    ...
    consonant_phoneme_list: List[Optional[P]] = [None] + [
