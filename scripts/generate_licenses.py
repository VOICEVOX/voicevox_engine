...
def generate_licenses() -> list[License]:
    ...
    licenses += [
        ...
        License(
            ...
            license_text="scripts/licenses/open_jtalk/COPYING",
        ...
        License(
            ...
            license_name="Modified BSD license",
            license_text="scripts/licenses/open_jtalk/mecab/COPYING",
            license_text_type="local_address",
        ),
        License(
            ...
            package_version=None,
            license_name="Modified BSD license",
            license_text="scripts/licenses//open_jtalk/mecab-naist-jdic/COPYING",
            license_text_type="local_address",
        ),
        License(
        ...
        License(
            ...
            license_name="LGPL-2.1 license",
            license_text="scripts/licenses/mpg123/COPYING",
            license_text_type="local_address",
        ),
        # liblame
        ...
        License(
            ...
            license_name=None,
            license_text="scripts/licenses/cuda/EULA.txt",
            license_text_type="local_address",
        ),
        ...
        License(
            ...
            license_name=None,
            license_text="scripts/licenses/cudnn/LICENSE",
            license_text_type="local_address",
        ),
    ]
