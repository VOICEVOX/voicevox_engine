...
def test_post_synthesis_200(client: TestClient, snapshot: SnapshotAssertion) -> None:
    response = client.post("/synthesis", params={"speaker": 0}, json=_query)
...
def test_post_synthesis_with_invalid_style_422(
    client: TestClient, style_id: int, snapshot_json: SnapshotAssertion
) -> None:
    response = client.post("/synthesis", params={"speaker": style_id}, json=_query)
