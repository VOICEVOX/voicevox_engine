...
if __name__ == "__main__":
    ...
    print(f"全ての喋れるキャラクター `GET /speaker_info` fakeserve: {result_spk_infos_fakeserve} sec")
    print(f"全ての喋れるキャラクター `GET /speaker_info` localhost: {result_spk_infos_localhost} sec")
    ...
    print("全ての喋れるキャラクター `GET /` fakeserve: {:.3f} sec".format(req_time_all_fake))
    print("全ての喋れるキャラクター `GET /` localhost: {:.3f} sec".format(req_time_all_local))
