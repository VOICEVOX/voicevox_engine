...
class TestSynthesisEngine(TestCase):
    ...
    def test_create_accent_phrases_これはありますか_question_mark_not_enable_interrogative(
        self,
    ):
        text = "これはありますか？"
        expected = [
    ...
    def test_create_accent_phrases_ん_question_mark_not_enable_interrogative(self):
        text = "ん？"
        expected = [
            AccentPhrase(
                moras=[
    ...
    def test_create_accent_phrases_っ_question_mark_not_enable_interrogative(self):
        text = "っ？"
        expected = [
            AccentPhrase(
                moras=[
    ...
    def test_create_accent_phrases_す_question_mark_not_enable_interrogative(self):
        text = "す？"
        expected = [
            AccentPhrase(
                moras=[
